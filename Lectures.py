...
class Lecture1(Lecture):
    def __init__(self):
        ...
        self.noise_mod = 7
        super().__init__("Lecture 1", self.dst_mod * self.obstacle_mod - 1)
    ...
    def reset_game(self, config):
        ...
        while len(home_players) > len(home_coords):
            home_players.pop()

        while len(away_players) > len(away_coords):
            away_players.pop()
        ...
        p_carrier = home_players.pop()
        move_player_within_square(game, p_carrier, home_coords[0][0], home_coords[0][1], give_ball=True)

        # setup opponents
        for a in range(len(away_players)):
            p = away_players.pop()
            move_player_within_square(game, p, away_coords[a][0], away_coords[a][1])

        # setup own team
        for a in range(len(home_players) - 1):
            p = home_players.pop()
            move_player_within_square(game, p, home_coords[a + 1][0], home_coords[a + 1][1])
...
class Lecture3(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 3", self.dst_mod * self.obstacle_mod - 1)
...
class Lecture4(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 4", self.dst_mod * self.obstacle_mod - 1)
    ...
    def reset_game(self, config):
        ...
        away_coords = [[9, 2], [9, 3], [11, 3], [13, 2], [15, 3], [16, 5]]
...
class Lecture5(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 5", self.dst_mod * self.obstacle_mod - 1)
...
class Lecture6(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 6", self.dst_mod * self.obstacle_mod - 1)
    ...
    def reset_game(self, config):
        ...
        away_coords = [[9, 2], [10, 2], [10, 5], [10, 6], [10, 7], [11, 5], [11, 6], [11, 13], [12, 5], [12, 9], [12, 11]]
...
class Lecture7(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 7", self.dst_mod * self.obstacle_mod - 1)
...
class Lecture8(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 8", self.dst_mod * self.obstacle_mod - 1)
    ...
    def reset_game(self, config):
        ...
        away_coords = [[13, 7], [13, 9], [13, 8], [3, 2], [3, 4], [3, 6], [3, 8], [3, 10], [3, 12], [3, 14], [4, 8]]
...
class Lecture10(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 10", self.dst_mod * self.obstacle_mod - 1)
    ...
    def reset_game(self, config):
        ...
        # inserting coords for players according to lectures
        home_coords = [[15, 12], [13, 7], [13, 9], [13, 12], [13, 13], [14, 7], [14, 8], [14, 9], [15, 13], [16, 11]]  # 1st one is the ball p_carrier #TODO czerwony
        away_coords = [[11, 6], [12, 6], [12, 7], [12, 9], [11, 12], [12, 13], [14, 11], [14, 12], [15, 14]]
...
class Lecture14(Lecture):
    def __init__(self):
        ...
        self.action_started_mod = 2
        self.noise_mod = 7
        super().__init__("Lecture 14", self.dst_mod * self.obstacle_mod - 1)
    ...
    def reset_game(self, config):
        ...
        # inserting coords for players according to lectures
        home_coords = [[14, 5], [14, 6], [14, 7], [14, 8], [14, 9], [14, 10], [14, 12], [13, 6], [13, 7], [22, 8]]  # 1st one is the ball p_carrier #TODO czerwony
        away_coords = [[12, 4], [12, 5], [12, 6], [12, 7], [12, 9], [12, 10], [12, 11], [12, 12], [13, 8], [13, 9]]
